window.TRANSLATIONS = {
  en: {
    ...
    download: {
      ...
      lead:
        "Stable builds are published through GitHub Releases. Grab version 1.1.0 and keep the quick start guide close when setting up.",
      primaryCta: "Download Shell Sentinel 1.1",
  ...
  es: {
    ...
    download: {
      ...
      lead:
        "La versión estable 1.1.0 está disponible en GitHub Releases. Descárgala y ten la guía de inicio rápido a mano durante la instalación.",
      primaryCta: "Descargar Shell Sentinel 1.1",
  ...
  de: {
    ...
    download: {
      ...
      title: "Download & Onboarding",
      lead:
        "Der stabile Release 1.1.0 steht über GitHub Releases bereit. Lade ihn herunter und halte den Schnellstart für die Einrichtung bereit.",
      primaryCta: "Shell Sentinel 1.1 herunterladen",
